...
///
/// Sirve para desarrollar la UI (#71) y para los tests del repositorio mientras no existe la
/// tabla `jornada` en la DB cifrada. **No es código de producción**: no persiste nada entre
/// ejecuciones.
final class JornadaLocalDataSourceEnMemoria implements JornadaLocalDataSource {
  ...
  Future<void> insertar(JornadaModel jornada) async {
    ...
    // que es lo que la tabla real resuelve con su restricción.
